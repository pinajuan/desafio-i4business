...
public class PoteValidator extends Validator {
    ...
    public PoteValidator(ValidationHandler aHandler, Pote pote) {
        super(aHandler);
        this.pote = pote;
    }
    ...
    private void checkNameConstraints() {
        final var name = this.pote.getNome();
        if (name == null) {
    ...
    private void checkDescricaoConstraints() {
        final var descricao = this.pote.getDescricao();
        if (descricao == null) {
